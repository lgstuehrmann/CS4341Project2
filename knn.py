...
for k in neighbors:
    ...
    print(k)
# neigh = KNeighborsClassifier(n_neighbors=5, weights=weight, algorithm=algo, leaf_size=leaf, p=p, metric='minkowski', metric_params=None, n_jobs=1)
# neigh.fit(images_train, labels_train)
# result = neigh.predict(images_test)
# print(confusion(labels_test, result))
